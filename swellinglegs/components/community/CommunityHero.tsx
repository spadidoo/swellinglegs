...
// Floating clinic photos behind the hero text — replace with real clinic images
...
export default function CommunityHero() {
  return (
    ...
    >
      {/* Floating photos — visible on sm+ only */}
      ...
      {/* Pulsing ring decorations — subtle depth */}
      <motion.div
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        >
          Events, videos, patient stories, and ways to connect with our clinic.
        </motion.p>
